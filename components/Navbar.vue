...
<div class="topnav" id="myTopnav">
  ...
  <span class="link"><router-link to="/">Green X</router-link></span>
...
@media screen and (max-width: 600px) {
  .topnav span.link:not(:first-child), #locale-select {display: none;}
  .topnav span.icon {
    float: right;
    display: block;
    position: absolute;
